...
export const IconCameras = ({ className }) => {
  return (
    <svg
      className={`icon-cameras ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 48 48"
      width="48"
    ...
    >
      <g className="g" clipPath="url(#clip0_2603_1937)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_2603_1937">
