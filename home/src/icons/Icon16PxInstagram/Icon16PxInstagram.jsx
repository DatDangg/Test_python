...
export const Icon16PxInstagram = ({ className }) => {
  return (
    <svg
      className={`icon-16px-instagram ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_2615_1692)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_2615_1692">
